...
const productRoute = document.body?.dataset.routeProducto || "producto";
const productsBase = document.body?.dataset.productsBase || "images/productos";
const normalizeBase = (base) => String(base || "").replace(/\/$/, "");
const buildProductUrl = (id) => {
  const url = new URL(productRoute, window.location.origin);
...
const createProductCard = (product) => {
  ...
  image.src = buildProductImageUrl(product.imagen);
